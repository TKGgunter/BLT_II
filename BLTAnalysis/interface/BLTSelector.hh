...
public :
    ...
    //NOTE: I don't understand why this did not work with it was active code.
    //I do not understand the purpose of ClassDef.
...
void BLTSelector::Init(TTree *tree)
{
    ...
    fChain->SetBranchAddress("GenJet", &fGenJetArr, &b_GenJetArr);
